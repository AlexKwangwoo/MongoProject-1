    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.prev = 1;
          // 패스워드를 입력하면 쿠키 초기화 해줄것임! authController에서 updatePassword에서 createSendToken을 하기에
...
var bookTour = exports.bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          stripe = Stripe('pk_test_51ObxS7L5FuoBpeMWDbNPY0GHYBJtyAtK2psheIPLj1G8CUPK0V6x0lWOzDem05LZauUHsI65vQIliK0Wo7goqlcU00Rb7aPPMl');
          _context.prev = 1;
...
if (bookBtn) bookBtn.addEventListener('click', function (e) {
  ...
  //tour.pug에서  tour-id 라된게 tourId 로 바뀐다
